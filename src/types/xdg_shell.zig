...
pub const XdgToplevel = extern struct {
    ...
    extern fn wlr_xdg_toplevel_set_size(toplevel: *wlr.XdgToplevel, width: u32, height: u32) u32;
    ...
    extern fn wlr_xdg_toplevel_set_parent(toplevel: *wlr.XdgToplevel, parent: ?*wlr.XdgToplevel) void;
